...
async def run_test():
    ...
    try:
        ...
        # -> Fill the project name field and create the project by submitting the form.
        frame = context.pages[-1]
        # Input text
        elem = frame.locator('xpath=/html/body/div[2]/form/div/div/input').nth(0)
        await page.wait_for_timeout(3000); await elem.fill('FontFamilyChange Project')
        ...
        # -> Click the '+ Texto' control to add a text element to the canvas.
        frame = context.pages[-1]
        # Click element
