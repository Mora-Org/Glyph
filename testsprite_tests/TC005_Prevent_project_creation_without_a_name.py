...
async def run_test():
    ...
    try:
        ...
        # -> Submit the create-project form with an empty project name by clearing input [6] and clicking the 'Criar Projeto' button [75], then verify a validation error is shown.
