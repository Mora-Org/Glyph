...
async def run_test():
    ...
    try:
        ...
        # -> Fill the project name input with 'Projeto Ensaio 01' (index 5) and click the 'Criar Projeto' button (index 75) to enter the Editor view.
        # text input placeholder="ex: Ensaio Verão 2026"
        elem = page.locator("xpath=/html/body/div[2]/div[3]/form/div[2]/input").nth(0)
        await elem.wait_for(state="visible", timeout=10000)
        await elem.fill("Projeto Ensaio 01")
