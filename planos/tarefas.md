...
- [/] **Fase 4: Tipografia & GIF** (Lettering Split, GIFs, Efeitos) — **EM TESTES**
- [/] **Fase 5: Exportação** (FFmpeg Pipeline, GPU Detection) — **EM DESENVOLVIMENTO**
...
---
> [!IMPORTANT]
> A transição de nome de PEG para **Glyph** envolve não apenas a mudança textual, mas a adoção da filosofia de "Pausa e Profundidade" da **Mora**. A Fase 6 será o momento de alinhar toda a UI e o código (`identifier`, `package.json`) com esta nova marca.
